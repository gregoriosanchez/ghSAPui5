...
var DataAccess = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                if (containedEntityType) {
                    ...
                    if (this.metadata.isDraftEntity(entitySet)) {
                        ...
                        if (this.debug) {
                            this.log.info('Creating entity for ' + entitySet.name);
                        }
    ...
    DataAccess.prototype.performAction = function (odataRequest, actionData) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var rootEntitySet, currentEntityType, currentEntitySet, i, _loop_1, entitySetName, actionName, fqActionName, actionDefinition, collecfqActionName, collecactionDefinition, actionName, fqActionName, actionDefinition, targetEntitySet_1, outData, enrichElement_1, outData, fqActionName_1, actionDefinition_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1: return [2 /*return*/, (_b.sent()).executeAction(actionDefinition, actionData, odataRequest, odataRequest.query.queryPath[i - 1].keys)];
                    case 2:
                        ...
                        return [4 /*yield*/, this.getMockEntitySet(entitySetName)];
                    case 3: return [2 /*return*/, (_b.sent()).executeAction(collecactionDefinition, actionData, odataRequest, odataRequest.query.queryPath[0].keys)];
                    ...
                    case 6:
                        outData = (_b.sent()).executeAction(actionDefinition, Object.assign({}, actionData, odataRequest.query.rawParams), odataRequest, odataRequest.query.rawParams);
                    ...
                    case 8:
                        outData = (_a = (_b.sent())) === null || _a === void 0 ? void 0 : _a.executeAction(actionDefinition, Object.assign({}, actionData, odataRequest.query.rawParams), odataRequest.query.rawParams);
                        return [2 /*return*/, outData];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getMockEntitySet(entitySetName)];
                    case 1: return [2 /*return*/, (_a.sent()).performPATCH(odataRequest.query.queryPath[0].keys, patchData, odataRequest.tenantId, true)];
                }
            });
        });
    };
    ...
    DataAccess.prototype.getParentEntity = function (keyValues, tenantId, entitySetDefinition) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        switch (_c) {
                            ...
                            case this.entitySetDefinition.annotations.Common.DraftRoot.PreparationAction + "(" + this.entitySetDefinition.entityTypeName + ")": return [3 /*break*/, 3];
                            case this.entitySetDefinition.annotations.Common.DraftRoot.PreparationAction + "()": return [3 /*break*/, 3];
                            case this.entitySetDefinition.annotations.Common.DraftRoot.DiscardAction + "(" + this.entitySetDefinition.entityTypeName + ")": return [3 /*break*/, 4];
                            case this.entitySetDefinition.annotations.Common.DraftRoot.DiscardAction + "()": return [3 /*break*/, 4];
                            case this.entitySetDefinition.annotations.Common.DraftRoot.ActivationAction + "(" + this.entitySetDefinition.entityTypeName + ")": return [3 /*break*/, 6];
                            case this.entitySetDefinition.annotations.Common.DraftRoot.ActivationAction + "()": return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 12];
                    case 1: return [4 /*yield*/, this.draftEdit(keys, odataRequest)];
                    case 2:
                        _f.sent();
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 13];
                    case 4: return [4 /*yield*/, this.draftDiscard(keys, odataRequest.tenantId)];
                    case 5:
                        // Discard
                    ...
                    case 9:
                        _i++;
                        return [3 /*break*/, 7];
                    case 10: return [4 /*yield*/, this.draftDiscard(keys, odataRequest.tenantId)];
                    case 11:
                        _f.sent();
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.dataAccess.getParentEntity(keyValues, tenantId, this.entitySetDefinition)];
                    case 2:
...
var FunctionBasedMockData = /** @class */ (function (_super) {
    ...
    function FunctionBasedMockData(mockDataFn, entityType, mockDataEntitySet, contextId) {
        ...
        _this = _super.call(this, ((mockDataFn === null || mockDataFn === void 0 ? void 0 : mockDataFn.getInitialDataSet) ? mockDataFn.getInitialDataSet(contextId) : noMock) || noMock, entityType, mockDataEntitySet) || this;
                        ...
                        return __generator(this, function (_a) {
                            try {
                                ...
                                request.getBodyAsString(function (body) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, dataAccess.updateData(odataReq_2, JSON.parse(body))];
                                            case 1:
                                                data = _a.sent();
...
var LITERAL = chevrotain_1.createToken({
    name: 'Literal',
    pattern: /(:?null|true|false|[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}|[0-9]{4}-[0-9]{2}-[0-9]{2}|-?(:?0|[1-9]\d*)(\.\d+)?(:?[eE][+-]?\d+)?|'[^\\"\n\r\']+')/
});
...
var FilterParser = /** @class */ (function (_super) {
    ...
    function FilterParser() {
        ...
        $.lambdaOperator = $.RULE('lambdaOperator', function () {
            ...
            $.CONSUME(COLON);
            var subExpr = $.SUBRULE($.expression);
            $.OPTION(function () {
                $.CONSUME(CLOSE);
            });
            return {
        ...
        $.expression = $.RULE('expression', function () {
            var isExprOpen = $.OPTION1(function () { return $.CONSUME(OPEN); });
            var identifier = $.OR([
                {
                    ALT: function () { return $.SUBRULE($.memberExpr); }
                },
            ...
            $.OPTION2(function () {
                ...
                $.OPTION3(function () {
                    ...
                    $.OPTION4(function () { return $.CONSUME(CLOSE); });
                });
                ...
                $.OPTION5(function () {
                    ...
                    $.CONSUME6(WS);
                    isOpen = $.OPTION6(function () { return $.CONSUME2(OPEN); });
                    ...
                    else if ((currentOperator === 'AND' && isOpen === undefined) ||
                    ...
                    //currentOperator = subExpr.operator;
                    $.OPTION7(function () { return $.CONSUME2(CLOSE); });
                });
                $.OPTION8(function () { return $.CONSUME3(CLOSE); });
            });
