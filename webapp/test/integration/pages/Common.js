sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ui16/productos/app", ".html");
		...
		return Opa5.extend("ui16.productos.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ui16/productos/localService/mockserver"], function (mockserver) {
